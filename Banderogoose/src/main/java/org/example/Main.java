...
public class Main extends TelegramLongPollingBot {
    //http://t.me/Banderogoose2023Bot
    //5652740769:AAHZuJbPzgDxi_bEr2T4E7rrI7h3x0bVj6o
    ...
    public String getBotUsername() {
        return "Banderogoose2023Bot";
    }

    @Override
    public String getBotToken() {
        return "5652740769:AAHZuJbPzgDxi_bEr2T4E7rrI7h3x0bVj6o";
    }
...
//            send message
        ...
        if (update.hasCallbackQuery()) {
            if (update.getCallbackQuery().getData().equals("Level_1_task") && grtLevel(chatId) == 1) {
//                increase Level
                setLevel(chatId, 2);
//                send image
...
//                send message
            ...
            if (update.hasCallbackQuery()) {
                if (update.getCallbackQuery().getData().equals("Level_2_task") && grtLevel(chatId) == 2) {
//                increase Level
                    setLevel(chatId, 3);
//                send image
...
//                send message
                ...
                if (update.hasCallbackQuery()) {
                    if (update.getCallbackQuery().getData().equals("Level_3_task") && grtLevel(chatId) == 3) {
//                increase Level
                        setLevel(chatId, 4);
//                send image
...
//                send message
                    ...
                    if (update.hasCallbackQuery()) {
                        if (update.getCallbackQuery().getData().equals("Level_4_task") && grtLevel(chatId) == 4) {
//                increase Level
                            setLevel(chatId, 5);
//                send image
...
//                send message
    ...
    public int grtLevel(Long chatId) {
